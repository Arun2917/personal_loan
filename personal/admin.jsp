<%-- 
    Document   : admin
    Created on : Jun 10, 2022, 1:33:14 PM
    Author     : Java
--%>
                        ...
                        <div class="row">
                            <div class="col-md-4 stretch-card grid-margin">
                                <div class="card bg-gradient-danger card-img-holder text-white">
                                    <div class="card-body">
                                        ...
                                        <h4 class="font-weight-normal mb-3">Total Registered users<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                                        </h4>
                                        <%

                                            try {
                                                PreparedStatement ps = Database.con().prepareStatement("select count(uid) from user");

                                                ResultSet check = ps.executeQuery();

                                                while (check.next()) {
                                        %>
                                        <h2 class="mb-5"><%=check.getString("count(uid)")%></h2>
                                        <%
                                                }
                                            } catch (Exception ae) {
                            ...
                            <div class="col-md-4 stretch-card grid-margin">
                                <div class="card bg-gradient-info card-img-holder text-white">
                                    <div class="card-body">
                                        <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                                        <h4 class="font-weight-normal mb-3">Total Loan Applications <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                                        </h4>
                                        <h2 class="mb-5">45</h2>
                                    </div>
                                </div>
