<%-- 
    Document   : processapplication
    Created on : Jun 17, 2022, 1:07:33 PM
    Author     : Java
--%>
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="admin.jsp"><img src="assets/images/logo-mini.svg" alt="logo" /></a>
                </div>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="processcheck.jsp" method="post">

                                <%
                                    String id = request.getParameter("uid");
                                    
                                    try {
                                        PreparedStatement ps = Database.con().prepareStatement("select * from loanapplication where uid='" + id + "' ");
                                ...
                                <div class="form-group row">
                                    <label for="exampleInputMobile" class="col-sm-3 col-form-label">Loan Amount</label>
                                    <div class="col-sm-9">
                                        <input disabled="" type="text" class="form-control" id="exampleInputMobile" value="<%=check.getString("cash")%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Interest Rate</label>
                                    <div class="col-sm-9">
                                        <input name="irate" type="number" class="form-control" id="exampleInputPassword2" placeholder="set interest rate %" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Duration</label>
                                    <div class="col-sm-9">
                                        <input disabled="" type="text" class="form-control" id="exampleInputConfirmPassword2" value="<%=check.getString("duration")%> Moths">
                                    </div>
                                </div>

                                <input type="submit" class="btn btn-gradient-primary mr-2" value="Send">
