<%-- 
    Document   : user
    Created on : Jun 10, 2022, 1:03:33 PM
    Author     : Java
--%>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> <%=check.getString("email")%></td>

                                                <td> <%=check.getString("phone")%> </td>
                                                <td> <%=check.getString("address")%> </td>
                                                <td> <%=check.getString("occupation")%> </td>
                                                <td><%=check.getString("rdate")%> </td>
                                                <td><a href="deleteuser.jsp?uid=<%=check.getInt("uid")%>"><i  class="mdi mdi-delete" style="size: 20px"></i></a> </td>
                                            </tr>
