<%-- 
    Document   : Allhistory
    Created on : Jun 22, 2022, 12:38:12 PM
    Author     : Java
--%>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <%
                                            ...
                                            try {
                                                PreparedStatement ps = Database.con().prepareStatement("select * from loanhistory");
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> <%=check.getInt("id")%></td>
                                                       <td> <%=check.getString("uid")%></td>

                                                <td>

                                                    <%=check.getString("uname")%>
                                                </td>
                                                <td> <%=check.getString("cash")%></td>

                                                <td> <%=check.getString("duration")%> </td>
                                                <td> <%=check.getString("rate")%> </td>
