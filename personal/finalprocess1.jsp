<%-- 
    Document   : finalprocess1
    Created on : Jun 20, 2022, 12:06:54 PM
    Author     : Java
--%>
...
Statement st = Database.con().createStatement();
            ...
            while (rs21.next()) {
                ...
                String rate = rs21.getString("irate");PreparedStatement check2=con2.prepareStatement("select * from user where uid="+id);
...
System.out.println("Key is............."+e);
                                ...
                                String txt=id.trim().concat(": Your Application for Personal Loan Is Rejected by the Manager.We will Get back to you with another offer. ");
